...
export class BioAcousticPhysics {
  ...
  public static readonly SPECIMENS: Record<string, BioSpecimenProfile> = {
    'healthy-somatic': {
      ...
      category: 'cell',
      badge: '🛡️ Intact Cortex',
      description: 'Ordered F-actin cytoskeleton with high cortical stiffness, exhibiting stable spherical harmonic pulsation.',
    ...
    'malignant-cancer': {
      ...
      category: 'cell',
      badge: '⚠️ Softened Cortex',
      description: '85% actin cortex depolymerization and high fluidity, triggering dynamic asymmetric membrane blebs.',
      radiusMicroMeters: 11.5,
      youngsModulusKPa: 0.35,
      corticalTensionMNm: 0.04,
      densityKgM3: 1045.0,
      compressibilityPa: 4.38e-10,
      viscosityMPaS: 1.8,
    ...
    'viral-capsid': {
      ...
      category: 'pathogen',
      badge: '🦠 Elastic Nanosphere',
      description: 'Icosahedral crystalline protein shell exhibiting high-order GHz spheroidal Lamb resonance.',
    ...
    'bacterial-wall': {
      ...
      category: 'pathogen',
      badge: '🧪 Peptidoglycan Shell',
      description: 'Rigid crosslinked peptidoglycan sacculus supporting turgor pressure with MHz shear modes.',
    ...
    'histotripsy-cavitation': {
      ...
      name: 'Histotripsy Cavitation Lysis',
      category: 'therapeutic',
      badge: '💥 Acoustic Ablation',
      description: 'High-intensity focused ultrasound (HIFU) inducing inertial bubble collapse and mechanical membrane lysis.',
      radiusMicroMeters: 10.0,
